alter table public.leads add column google_place_id text;

drop function if exists public.submit_all_season_lead(
  uuid, uuid, text, text, text, text, text, timestamptz, jsonb, text, text,
  text, integer, text, text
);

create function public.submit_all_season_lead(
  p_company_id uuid,
