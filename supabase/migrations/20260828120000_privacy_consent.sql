create table public.privacy_consent_evidence (
  ...
  advertising_granted boolean not null default false,
...
grant select on public.privacy_consent_evidence to service_role;
...
begin
  insert into public.privacy_consent_evidence(
    ...
    true, coalesce(p_analytics_granted, false), coalesce(p_advertising_granted, false),
